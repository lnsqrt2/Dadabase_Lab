...
public:
    ...
    void setupUi(QWidget *ServerWidget)
    {
        ...
        ButtonData = new QPushButton(ServerWidget);
        ButtonData->setObjectName(QStringLiteral("ButtonData"));
        ButtonData->setGeometry(QRect(140, 180, 112, 34));
    ...
    void retranslateUi(QWidget *ServerWidget)
    {
        ...
        ButtonData->setText(QApplication::translate("ServerWidget", "\346\225\260\346\215\256\347\256\241\347\220\206", 0));
    } // retranslateUi
